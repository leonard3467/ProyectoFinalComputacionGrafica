...
glm::vec3 position2(-27.0f, 3.5f, -29.0f);
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// --- TORSO
		animaciones.movimientoTablero(position, rotacionDipper, saltoDipperY, desplazamientoDipper, pasos, deltaTime, mainWindow, Tiempo, desplazamientoDipperz, rotacionDipperAux);
