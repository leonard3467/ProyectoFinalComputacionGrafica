...
void Animaciones::controlAnimacionTablero(glm::vec3& posicion,
    ...
    switch (idCasilla) {
    case 1:  
        animacionTablero(posY1, rotacion1, deltaTime); //Casilla Guau contador
        break;
    case 2:  
        animacionTablero(posY2, rotacion2, deltaTime); //Casilla Start
        break;
    case 3: 
        animacionTablero(posY3, rotacion3, deltaTime); //Casilla Chapoteo
        break;
    case 4:  
        animacionTablero(posY4, rotacion4, deltaTime); //Casilla Floripondio
        break;
    case 5:
        animacionTablero(posY5, rotacion5, deltaTime); // Casilla Brillantina
        break;
    case 6:
        animacionTablero(posY6, rotacion6, deltaTime); //Casilla Determindes
        break;
    case 7:
        animacionTablero(posY7, rotacion7, deltaTime); //Casilla Impacto
        break;
    case 8:
        animacionTablero(posY8, rotacion8, deltaTime); 
        break;
    case 9:
        animacionTablero(posY9, rotacion9, deltaTime); //Casilla Esperanza 
        break;
    case 10:
        animacionTablero(posY10, rotacion10, deltaTime); //Casilla Yahoo 
        break;
    case 11:
        animacionTablero(posY11, rotacion11, deltaTime); //Mystery shack
        break;
    case 12:
        animacionTablero(posY12, rotacion12, deltaTime); //Casilla lento
        break;
    case 13:
        animacionTablero(posY13, rotacion13, deltaTime); //Casilla Castillo del terror
        break;
    case 14:
        animacionTablero(posY14, rotacion14, deltaTime); //Casilla Relajate
        break;
    case 15:
        animacionTablero(posY15, rotacion15, deltaTime); //Casilla Cuidado
        break;
    case 16:
        animacionTablero(posY16, rotacion16, deltaTime);
        break;
